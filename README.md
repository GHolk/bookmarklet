...
[facebook image downloader]: javascript:void%20function%20()%20%7Bclass%20FacebookImageDownloader%7Bstatic%20run()%7B(new%20this).init()%7Dinit()%7Bthis.end%3D!1%2Cthis.url%3Dnull%2Cthis.watch()%7Ddownload(...args)%7Breturn%20this.downloadFetch(...args)%7Dasync%20downloadFetch(url)%7Bconst%20res%3Dawait%20fetch(url)%2Cblob%3Dawait%20res.blob()%2CblobUrl%3DURL.createObjectURL(blob)%3Bthis.downloadBookmarklet(blobUrl)%2Cawait%20this.sleep(.2)%2CURL.revokeObjectURL(blobUrl)%7DdownloadTridactyl(url)%7Bthis.tri.messaging.message(%22download_background%22%2C%22downloadUrl%22%2Curl%2C!1)%7DdownloadBookmarklet(url%2Cname%3DDate.now().toString())%7Bconst%20a%3Ddocument.createElement(%22a%22)%3Ba.href%3Durl%2Ca.download%3Dname%2Cdocument.body.appendChild(a)%2Ca.click()%2Ca.remove()%7Dsleep(second)%7Breturn%20new%20Promise(wake%3D%3EsetTimeout(wake%2C1e3*second))%7Dasync%20watch()%7Bfor(%3B!this.end%3B)%7Bawait%20this.sleep(.2)%3Bconst%20url%3Dwindow.location.href%3Bif(url%3D%3Dthis.url)continue%3Bthis.url%3Durl%3Bconst%20image%3Ddocument.querySelectorAll(%22%5Brole%20%3D%20main%5D%20img%22)%3B1!%3Dimage.length%3Falert(%22find%20more%20than%201%20image%22)%3Athis.download(image%5B0%5D.src)%7D%7Dstatic%20runTridactyl()%7Btri.FacebookImageDownloader%7C%7C(tri.FacebookImageDownloader%3DFacebookImageDownloader)%2Ctri.FacebookImageDownloader.instance%3F(tri.FacebookImageDownloader.instance.end%3D!0%2Ctri.FacebookImageDownloader.instance%3Dnull)%3A(tri.FacebookImageDownloader.instance%3Dnew%20tri.FacebookImageDownloader%2Ctri.FacebookImageDownloader.instance.init())%7D%7DFacebookImageDownloader.run()%3B%7D()
